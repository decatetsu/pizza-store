...
function Cart() {
    ...
    function onClearCart() {
        if (window.confirm('Ви дійсно хочете спустошити кошик?')) {
            dispatch(clearCart());
        }
    }

    function onRemoveItem(id) {
        if (window.confirm('Ви дійсно хочете видалити цю піцу?')) {
            dispatch(removeCartItem(id));
        }
    }

    function onPlusCartItem(id) {
        dispatch(plusCartItem(id));
    }

    function onMinusCartItem(id) {
                ...
                : <div className="cart">
                    <div className="cart__top">
                        ...
                        <div className="cart__clear">
                            ...
                            <span onClick={onClearCart}>Спустошити кошик</span>
                        </div>
                    </div>
                    <div className="content__items">
                        {
                            cartPizzas.map(obj => <CartItem key={obj.id} id={obj.id} name={obj.name} type={obj.type}
                                                            size={obj.size}
